...
[Heigwer et al., 2018, Time-resolved mapping of genetic interactions to model signaling pathway vulnerabilities,_eLife_, 2018](https://elifesciences.org/articles/40174) 
