...
date: "`r Sys.Date()`"
abstract: >
  Tumor phenotypes are closely associated with their developmental lineage and cell of origin. However, tumor lineage-specific genetic vulnerabilities remain sparsely characterized. In this work, we inferred lineage-dependencies across 21 different tumor types based on genome-scale CRISPR screening data. Our analysis identified 1653 lineage-specific essential genes, many of which have roles in signaling and development. Gene signatures associated with a loss of differentiation and epithelial to mesenchymal transition were strongly associated with resistance to the perturbation of lineage-specific essential processes in several tumor types. We show that in colorectal cancer, the developmental transcription factors KLF5, HNF4A and CDX2 and the Wnt-signaling effector TCF7L2 co-regulate many target genes. By contrast, decreased expression of developmental factors was associated with an increased resistance to Wnt-signaling perturbation. Our results suggest that cooperations between mutated signaling pathways and lineage-specific transcription factors mediate the outcome of aberrant signaling activity across a diverse range of tumor lineages. These interactions can determine whether targeted pathway inhibition will be effective in a particular cancer type.
